...
export default function App() {
  ...
  const theoSharePct = theoAsset ? (theoAsset.points * TIER_BONUS[theoTier] / EXPEDITION_DENOM) * 100 : 0;
  ...
  const additionalUSD = Math.floor(
    bonuses.filter(b => b.selected).reduce((sum, b) => sum + (b.pct / 100) * fdvUsd / b.supply, 0)
  );
...
// suite du fichier App.jsx (partie 2/3)
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 justify-items-center">
              <div className="flex flex-col space-y-6 w-full max-w-md">
                <div className="bg-gray-800 rounded-2xl shadow-lg p-4 space-y-2 w-full">
                  ...
                  <p className="text-white">Total Test $MITO: {testnetAsset && !isNaN(testnetAsset.points) ? Math.floor(testnetAsset.points).toLocaleString('fr-FR') : '0'}</p>
              ...
              // suite du fichier App.jsx (partie 3/3)

...
export default function App() {
  ...
  // Editable constants moved back into state
  ...
  const expeditionBoost    = expeditionAssets.length
    ...
    : 1
  const expeditionSharePct = (totalExpPoints * expeditionBoost / (expDenomBase * expDenomFactor)) * 100
  ...
  const theoSharePct       = (theoAsset.points * (TIER_BONUS[theoAsset.tier]||1) / (expDenomBase * expDenomFactor)) * 100
